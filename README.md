# Objective
This project explores how Microsoft Fabric and Azure OpenAI can analyze a document repository of text-based data. Microsoft Fabric offers a suite of data analytics tooling. It also offers the OneLake, an automatically provisioned enterprise data lake that can store any type of file, including unstructured text data. The intelligence of Azure OpenAI, combined with strategic prompting, extracts valuable information from text with remarkable efficiency. By combining Microsoft Fabric and Azure Open AI you will be able to analyze yout text-based data like never before. You will even be able to use notebooks and Power BI! Our document store for this walkthrough will be public domain eBooks.
